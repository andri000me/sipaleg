<?php
  ...
  if (isset($_POST['tambah'])){
    ...
    $queryAddAdmin = "INSERT INTO tb_admin VALUES ('', '$username', '$password','$nama', '$email', '$nama_foto_admin')";
    $up = updateData($queryAddAdmin);
    // echo $up;
    if ($up > 0) {
...
<html>
<head>
<title>Tambah data admin | SIPALEG ADMIN</title>
       ...
       <div class="modal-dialog" role="document">
         <div class="modal-content">
           <div class="modal-header">
             <h5 class="modal-title" id="exampleModalLabel"><i style="color: black;" class="fa fa-user fa-fw nav_icon"></i>Tambah Data Admin</h5>
           </div>
           <div class="modal-body">
             <form method="post" action="" enctype="multipart/form-data">
             <input type="text" class="form-control" id="ida" name="ida" value="" style="display: none;">
               ...
               <div class="form-group">
                 ...
                 <input type="file" class="form-control" id="foto_admin" name="foto_admin" required>
               </div>
               <div class="modal-footer">
                 ...
                 <button type="submit" class="btn btn-danger" name="tambah" id="tambah">Tambah Data Admin</button>
               </div>
             </form>
           </div>
