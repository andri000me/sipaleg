<?php
  ...
  $jumlahAdmin = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tb_admin"));

  $admins = mysqli_query($conn, "SELECT * FROM tb_admin");
  $dataAdmins = getData($admins);
  $dataPerPage = 5;
  if (isset($_GET)){
    if (empty($_GET['page'])) {
      $page = 1;
  ...
  $jumlahPage = ceil($jumlahAdmin/$dataPerPage);
  $akhirPage = $page*$dataPerPage;
  if ($akhirPage == ($jumlahPage*$dataPerPage) ) {
    $akhirPage = $page*$dataPerPage-($page*$dataPerPage-$jumlahAdmin);
  }
...
<html>
<head>
<title>Admin Management | SIPALEG ADMIN</title>
      ...
      <!-- /.navbar-static-side -->
	   ...
	   <div class="xs">
	     <div class="bs-example4" data-example-id="contextual-table">
	       <div class="table-wrapper">
	         <div class="table-title">
	           <div class="row">
	             ...
	             <div class="col-sm-7">
            <a href="add_admin" class="btn btn-primary"><i class="material-icons">&#xE147;</i> <span>Add New Admin</span></a>
            <!-- <a href="#" class="btn btn-primary"><i class="material-icons">&#xE24D;</i> <span>Export to Excel</span></a> -->
	         ...
	         <table class="table table-striped table-hover">
	           ...
	           <tbody>
	             ...
	             <tr>
                 <?php $admin = $dataAdmins[$i]; ?>
	               <td><?= $i+1 ?></td>
                  <td><img style="max-height: 50px;" src="../assets/img/admin/<?= $admin['foto_admin'] ?>" class="avatar"
	                   alt="Avatar+<?= $i+1 ?>"></td>
                  <td><?= $admin['username'] ?></td>
	               ...
	               <td>
	                 <a href="edit_data?admin=<?= $admin['id_admin'] ?>" class="settings" title="Edit"><i
                  class="material-icons">&#xE8B8;</i></a>
	                 <a href="delete_data?admin=<?= $admin['id_admin'] ?>" class="delete" title="Delete" data-toggle="tooltip">
           ...
           <div class="clearfix">
              <div class="hint-text">Showing <b><?= $akhirPage-$dataPerPage*($page-1) ?></b> out of <b><?= $jumlahAdmin ?></b> entries</div>
              <ul class="pagination">
                <?php if ($page != 1) : ?>
